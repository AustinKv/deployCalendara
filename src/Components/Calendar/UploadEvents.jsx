...
const UploadEvents = (props) => {
    ...
    const fetchEvents = async () => {
        try {
            const response = await axios.get(
                `https://calendarabackend.onrender.com/api/events/uploaded/${email}`
            );
    ...
    const handleCsvUpload = async () => {
        ...
        try {
            ...
            await axios.post(
                `https://calendarabackend.onrender.com/api/uploadcsv/${email}`,
                formData,
                {
                    headers: {
    ...
    const handleXlsxUpload = async () => {
        ...
        try {
            ...
            await axios.post(
                `https://calendarabackend.onrender.com/api/uploadxlsx/${email}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
    ...
    const handleHideModal = async () => {
        try {
            await axios.delete("https://calendarabackend.onrender.com/api/events/deleteUploaded");
            setCsvFile(null);
            setExcelFile(null);
            setEvents([]);
            setShowModal(false);
        ...
        try {
            await Promise.all(
                events.map(async (event) => {
                    await axios.put(
                        `https://calendarabackend.onrender.com/api/events/${event._id}/update`,
                        { uploaded: false }
                    );
                })
            );
