...
const Calendar = ({ mode }) => {
    ...
    const handleCreateEvent = async (data) => {
        try {
            ...
            const response = await axios.post(
                "https://calendarabackend.onrender.com/api/events",
                eventData
            );
    ...
    const handleEventClick = async (arg) => {
        try {
            ...
            const response = await axios.get(
                `https://calendarabackend.onrender.com/api/events/${eventId}/show`
            );
        ...
        try {
            ...
            if (eventToUpdate) {
                ...
                if (!isAllDay && isMultiDayEvent(start, end)) {
                    ...
                    await axios.put(
                        `https://calendarabackend.onrender.com/api/events/${eventToUpdate.id}/update`,
                        eventToUpdate
                    );
    ...
    const handleDeleteEvent = async () => {
        try {
            if (selectedEvent && selectedEvent._id) {
                ...
                await axios.delete(
                    `https://calendarabackend.onrender.com/api/events/${eventId}/delete`
                );
